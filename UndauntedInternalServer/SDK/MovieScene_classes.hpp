...
public:
	...
	TMulticastInlineDelegate<void()>              OnTick;                                            // 0x0458(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	struct FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                           // 0x04B0(0x0328)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_7D8[0x68];                                     // 0x07D8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x0840(0x0010)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                // 0x0850(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
