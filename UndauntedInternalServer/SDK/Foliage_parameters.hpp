...
public:
	...
	struct FHitResult                             OverlapInfo;                                       // 0x0020(0x0098)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
