...
public:
	...
	struct FBrushStampData                        LastBrushStamp;                                    // 0x00CC(0x00B8)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_184[0x14];                                     // 0x0184(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   PropertyClass;                                     // 0x0198(0x0028)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
