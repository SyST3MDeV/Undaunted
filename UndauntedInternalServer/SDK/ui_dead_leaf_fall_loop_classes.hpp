...
// WidgetBlueprintGeneratedClass ui_dead_leaf_fall_loop.ui_dead_leaf_fall_loop_C
// 0x0068 (0x0340 - 0x02D8)
class Uui_dead_leaf_fall_loop_C final : public UUserWidget
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x02D8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UWidgetAnimation*                       snow_loop;                                         // 0x02E0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_ui_dead_leaf_fall_loop(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("ui_dead_leaf_fall_loop_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ui_dead_leaf_fall_loop_C")
	}
	static class Uui_dead_leaf_fall_loop_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Uui_dead_leaf_fall_loop_C>();
	}
};
DUMPER7_ASSERTS_Uui_dead_leaf_fall_loop_C;
