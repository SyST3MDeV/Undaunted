...
struct EndOfHunt_SlayerLevel_C_ExecuteUbergraph_EndOfHunt_SlayerLevel final
{
public:
	...
	class UStackableProgressBar_C*                CallFunc_Create_ReturnValue;                       // 0x0048(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UXPBoost_IconWidget_C*                  CallFunc_Array_Get_Item;                           // 0x0050(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UStackableProgressBar_C*                CallFunc_Array_Get_Item_1;                         // 0x0068(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UOverlaySlot*                           CallFunc_AddChildToOverlay_ReturnValue;            // 0x0070(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetTrackNextRankProgress_Progress;        // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_BoostAmount;                    // 0x00BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UStackableProgressBar_C*                CallFunc_Array_Get_Item_2;                         // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_EndOfHunt_SlayerLevel_C_ExecuteUbergraph_EndOfHunt_SlayerLevel;

// Function EndOfHunt_SlayerLevel.EndOfHunt_SlayerLevel_C.BoostStatBars
// 0x0004 (0x0004 - 0x0000)
struct EndOfHunt_SlayerLevel_C_BoostStatBars final
{
public:
	float                                         BoostAmount;                                       // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_EndOfHunt_SlayerLevel_C_BoostStatBars;
