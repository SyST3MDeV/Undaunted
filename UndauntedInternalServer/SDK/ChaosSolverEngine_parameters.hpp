...
public:
	...
	struct FHitResult                             ReturnValue;                                       // 0x0070(0x0098)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
