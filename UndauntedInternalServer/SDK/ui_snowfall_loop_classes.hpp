...
// WidgetBlueprintGeneratedClass ui_snowfall_loop.ui_snowfall_loop_C
// 0x0068 (0x0340 - 0x02D8)
class Uui_snowfall_loop_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_ui_snowfall_loop(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("ui_snowfall_loop_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ui_snowfall_loop_C")
	}
	static class Uui_snowfall_loop_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<Uui_snowfall_loop_C>();
	}
};
DUMPER7_ASSERTS_Uui_snowfall_loop_C;
