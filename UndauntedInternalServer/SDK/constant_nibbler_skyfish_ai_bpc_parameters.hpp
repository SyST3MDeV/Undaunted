...
struct constant_nibbler_skyfish_ai_bpc_C_ExecuteUbergraph_constant_nibbler_skyfish_ai_bpc final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsOwnedByLocalClient_ReturnValue;         // 0x0004(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class Uconstant_nibbler_skyfish_ai_data_C*    K2Node_DynamicCast_AsConstant_Nibbler_Skyfish_Ai_Data; // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class Uconstant_nibbler_skyfish_ai_data_C*    K2Node_DynamicCast_AsConstant_Nibbler_Skyfish_Ai_Data_1; // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class Uconstant_nibbler_skyfish_ai_data_C*    K2Node_DynamicCast_AsConstant_Nibbler_Skyfish_Ai_Data_2; // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_constant_nibbler_skyfish_ai_bpc_C_ExecuteUbergraph_constant_nibbler_skyfish_ai_bpc;
