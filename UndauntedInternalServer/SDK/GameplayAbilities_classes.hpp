...
public:
	...
	static struct FVector EffectContextGetHitDirection(const struct FGameplayEffectContextHandle& EffectContext);
	...
	static struct FGameplayEffectContextHandle EffectContextSetHitDirection(const struct FGameplayEffectContextHandle& EffectContext, const struct FVector& HitDirection);
...
public:
	...
	TArray<struct FAttributeDefaults>             DefaultStartingData;                               // 0x0130(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_560[0x1E8];                                    // 0x0560(0x01E8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FActiveGameplayEffectsContainer        ActiveGameplayEffects;                             // 0x0858(0x0480)(Net, Protected, NativeAccessSpecifierProtected)
	...
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x1050(0x0010)(Net, ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_11E8[0x10];                                    // 0x11E8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetRemoveAbilityAfterActivation(const struct FGameplayAbilitySpecHandle& AbilitySpecHandle);
...
public:
	...
	TArray<struct FGameplayCuePendingExecute>     PendingExecuteCues;                                // 0x02E0(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         GameplayCueSendContextCount;                       // 0x02F0(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2F4[0x4];                                      // 0x02F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPreallocationInfo>             PreallocationInfoList_Internal;                    // 0x02F8(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
class UGameplayAbilityMontageCallback final : public UObject
{
public:
	TWeakObjectPtr<class UAbilitySystemComponent> AbilitySystemComponent;                            // 0x0028(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FActiveGameplayEffectHandle>    AppliedEffects;                                    // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(class UAnimMontage* Montage, bool bInterrupted)> Delegate;                        // 0x0040(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("GameplayAbilityMontageCallback")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GameplayAbilityMontageCallback")
	}
	static class UGameplayAbilityMontageCallback* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGameplayAbilityMontageCallback>();
	}
};
DUMPER7_ASSERTS_UGameplayAbilityMontageCallback;
...
public:
	float CalculateBaseMagnitude(const struct FActiveGameplayEffectHandle& ActiveEffect, const struct FGameplayEffectSpec& Spec) const;
