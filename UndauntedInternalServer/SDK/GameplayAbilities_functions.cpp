...
struct FVector UAbilitySystemBlueprintLibrary::EffectContextGetHitDirection(const struct FGameplayEffectContextHandle& EffectContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AbilitySystemBlueprintLibrary", "EffectContextGetHitDirection");

	Params::AbilitySystemBlueprintLibrary_EffectContextGetHitDirection Parms{};
...
struct FGameplayEffectContextHandle UAbilitySystemBlueprintLibrary::EffectContextSetHitDirection(const struct FGameplayEffectContextHandle& EffectContext, const struct FVector& HitDirection)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AbilitySystemBlueprintLibrary", "EffectContextSetHitDirection");

	Params::AbilitySystemBlueprintLibrary_EffectContextSetHitDirection Parms{};
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const struct FGameplayAbilitySpecHandle&AbilitySpecHandle                                      (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAbilitySystemComponent::SetRemoveAbilityAfterActivation(const struct FGameplayAbilitySpecHandle& AbilitySpecHandle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "SetRemoveAbilityAfterActivation");

	Params::AbilitySystemComponent_SetRemoveAbilityAfterActivation Parms{};
...
// (Native, Event, Public, HasOutParams, BlueprintEvent, Const)
// Parameters:
// const struct FActiveGameplayEffectHandle&ActiveEffect                                           (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FGameplayEffectSpec&       Spec                                                   (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// float                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float UGameplayModMagnitudeCalculation::CalculateBaseMagnitude(const struct FActiveGameplayEffectHandle& ActiveEffect, const struct FGameplayEffectSpec& Spec) const
{
	static class UFunction* Func = nullptr;
