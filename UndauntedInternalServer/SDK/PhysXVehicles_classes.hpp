...
// 0x0710 (0x0990 - 0x0280)
class UVehicleAnimInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_278[0x708];                                    // 0x0278(0x0708)(Fixing Size After Last Property [ Dumper-7 ])
	class UWheeledVehicleMovementComponent*       WheeledVehicleMovementComponent;                   // 0x0980(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
